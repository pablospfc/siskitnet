...
CREATE TABLE `tb_lancamento` (
  ...
  KEY `fk_lancamento_locatario` (`id_locatario`),
  KEY `fk_tb_lancamento_tb_status1_idx` (`id_status`),
  CONSTRAINT `fk_lancamento_locatario` FOREIGN KEY (`id_locatario`) REFERENCES `tb_locatario` (`id`),
...
INSERT INTO `tb_locatario` VALUES (6,3,'Claudio Pablo Silva Santos','04172473385','123123','Avenida Santos Dumont, 01, residencial canaã','2018-02-02','1212','MA','Analista de Sistemas','São Luis','asdasd','65046660','98988197084','csc@gmail.com',1,NULL),(7,3,'Braulio Roberto Silva Dantos','04172473385','9192030102','Avenida Santos Dumont, 01, residencial canaã','2018-01-01','ssp','ma','advogado','São Luis','anil','65046660','98988197084','pppp@gmail.com',1,NULL);
...
CREATE TABLE `tb_pagamento` (
  ...
  `ano` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_aluguel` (`id_locatario`),
  KEY `fk_mes` (`id_mes`),
  CONSTRAINT `fk_mes` FOREIGN KEY (`id_mes`) REFERENCES `tb_mes` (`id`),
  CONSTRAINT `fk_pagamento_locatario` FOREIGN KEY (`id_locatario`) REFERENCES `tb_locatario` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-09-14 22:30:22
