...
sisKitnetApp.controller('imovelModalController', ["$scope", "close", "$filter", "indenizacao", "SiskitnetService", function ($scope, close, $filter, indenizacao, SiskitnetService) {
