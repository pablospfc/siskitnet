...
sisKitnetApp.controller('LocatariosController', ["$scope", "$timeout", "ModalService", "SiskitnetService", function ($scope, $timeout, ModalService, SiskitnetService) {
...
sisKitnetApp.controller('locatarioModalController', ["$scope", "locatario", "SiskitnetService", function ($scope, locatario, SiskitnetService) {
...
sisKitnetApp.service('SiskitnetService', ["$http", "$httpParamSerializerJQLike", function ($http, $httpParamSerializerJQLike) {
