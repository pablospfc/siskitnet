...
sisKitnetApp.config(["$routeProvider", "$locationProvider", function($routeProvider, $locationProvider) {
    ...
    when('/conta', {
        ...
        resolve: {
            Usuario: ["SiskitnetService", function (SiskitnetService) {
 ...
 */
sisKitnetApp.controller('ContaController', ["$scope", "$document", "Usuario", "$location", "$timeout", "SiskitnetService", function ($scope, $document, Usuario, $location, $timeout, SiskitnetService) {
 ...
 * Created by claud on 23/02/2018.
 */
sisKitnetApp.controller('UsuarioController', ["$scope", "$document", "$location", "$timeout", "SiskitnetService", function ($scope, $document, $location, $timeout, SiskitnetService) {
