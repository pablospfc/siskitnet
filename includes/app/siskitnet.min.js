...
sisKitnetApp.controller('HomeController', ["$scope", "$document", "$timeout", "ModalService", "SiskitnetService", function ($scope, $document, $timeout, ModalService, SiskitnetService) {
...
sisKitnetApp.controller('LoginController', ["$scope", "$document", "$location", "$timeout", "AuthenticationService", function ($scope, $document, $location, $timeout, AuthenticationService) {
...
//                 };
//             }]);
sisKitnetApp.controller('LogoutController', ["$scope", "$document", "$location", "$timeout", "AuthenticationService", function ($scope, $document, $location, $timeout, AuthenticationService) {
    $scope.sair = function(){
        console.log("chegou aqui");
        AuthenticationService.ClearCredentials();
