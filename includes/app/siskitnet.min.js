...
sisKitnetApp.config(["$routeProvider", "$locationProvider", "$httpProvider", function($routeProvider, $locationProvider, $httpProvider) {
    ...
    when('/proprietario', {
        ...
        resolve: {
            Proprietario: ["SiskitnetService", function (SiskitnetService) {
 ...
 */
sisKitnetApp.controller('ContaController', ["$scope", "$document", "$location", "$timeout", "SiskitnetService", function ($scope, $document, $location, $timeout, SiskitnetService) {
...
sisKitnetApp.controller('IndenizacoesController', ["$scope", "$document", "$timeout", "ModalService", "SiskitnetService", function ($scope, $document, $timeout, ModalService, SiskitnetService) {
...
sisKitnetApp.controller('indenizacaoModalController', ["$scope", "close", "$filter", "indenizacao", "SiskitnetService", function ($scope, close, $filter, indenizacao, SiskitnetService) {
...
sisKitnetApp.controller('ProprietarioController', ["$scope", "$document", "Proprietario", "$location", "$timeout", "SiskitnetService", function ($scope, $document, Proprietario, $location, $timeout, SiskitnetService) {
 ...
 */
sisKitnetApp.controller('RedefinicaoSenhaController', ["$scope", "$document", "$timeout", "ModalService", "SiskitnetService", function ($scope, $document, $timeout, ModalService, SiskitnetService) {
...
sisKitnetApp.controller('RegistroController', ["$scope", "$document", "$timeout", "ModalService", "SiskitnetService", function ($scope, $document, $timeout, ModalService, SiskitnetService) {
...
sisKitnetApp.controller('RelatoriosController', ["$scope", "$document", "$timeout", "ModalService", "SiskitnetService", function ($scope, $document, $timeout, ModalService, SiskitnetService) {
 ...
 * Created by claud on 23/02/2018.
 */
sisKitnetApp.controller('UsuarioController', ["$scope", "$window", "$document", "PATHS", "$location", "$timeout", "SiskitnetService", function ($scope, $window, $document, PATHS,$location, $timeout, SiskitnetService) {
...
sisKitnetApp.service('SiskitnetService', ["$http", "$q", "$window", "$sce", "$rootScope", "$httpParamSerializerJQLike", function ($http, $q, $window, $sce, $rootScope,$httpParamSerializerJQLike) {
    /*LOCATÁRIOS*/
