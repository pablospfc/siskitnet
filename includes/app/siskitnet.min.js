...
sisKitnetApp.config(["$routeProvider", "$locationProvider", function($routeProvider, $locationProvider) {
    ...
    when('/contratos-vencidos', {
        templateUrl: 'templates/view/contrato/vencidos.html',
        controller: 'RenovacaoController',
        resolve: {
            Vencidos: ["SiskitnetService", function (SiskitnetService) {
...
sisKitnetApp.controller('RenovacaoController', ["$scope", "Vencidos", function ($scope, Vencidos) {
...
sisKitnetApp.service('SiskitnetService', ["$http", "$q", "$window", "$httpParamSerializerJQLike", function ($http, $q, $window, $httpParamSerializerJQLike) {
    /*LOCATÁRIOS*/
